    ...
    <Fragment>
      ...
      >
        ...
        <Row className="mb-3">
          ...
          <Form.Group md="1" controlId="validationCustom01">
            <Form.Check.Input
              required
              // label="2"
              name="group1"
        ...
        <Row className="mb-3">
          <div>
            ...
            <p>1. કોરોના મહામારી અન્વયની ગાઈડ-લાઈન નું પાલન કરવુ.</p>
            <p>2. ફરજિયાત માસ્ક પહેરવું.</p>
            <p>3. નિયત કરેલી પ્રવેશ ફી ભરવાની રહશે જે મળશે નહિ.</p>
            <p>4. તાલીમ વર્ગો નિઃશુલ્ક રહશે.</p>
            <p>
              5. મોબાઈલ સ્વિચ ઑફ રાખવાનો રહશે. અન્યથા નિયત કરેલો દંડ ભરવાનો
              રહશે.
            </p>
            <p>6. વર્ગમાં ગેરહાજર રહેનાર ને નિયત કરેલ દંડ ભરવો પડશે.</p>
            <p>7. આઈકાર્ડ ફરજિયાત પહેરવાનું રહશે</p>
            <p>
              8. વર્ગ શરુ થયા બાદ પણ રજુ થયેલા શિસ્તનાં નિયમોનું ફરજિયાત પાલન
              કરવાનું રહેશે.
            </p>
          </div>
          {/* Checkbox*/}
          ...
          >
            <p>
              હું પરિવર્તન એજ્યુકેશન ચેરીટેબલે ટ્રસ્ટના તમામ નિયમોનું પાલન કરવા
              બંધાયેલો છું અન્યથા એડમિશન રદ્દ થશે. જેની જવાબદારી મારી રહશે.
            </p>
          </div>
        </Row>

        {/* Submit */}
        <Row className="mb-3" as={Col} md="4">
