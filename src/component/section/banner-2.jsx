const subTitle = "Online training";
const title = (
  <h2 className="title">
    <span className="d-lg-block">FCB Training</span>
  </h2>
);
const desc = "Football Training Academy";
            ...
            <div className="col-xxl-7 col-xl-6">
              <div className="thumb-part">
                <div className="banner-thumb text-center">
                  <img src="assets/images/logo/01.png" alt="img" />
                </div>
